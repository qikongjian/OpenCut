  ...
  return (
    <div className="h-full flex flex-col bg-panel rounded-sm">
      ...
      <div className="flex items-center gap-2 p-4 border-b border-border">
        ...
        <h3 className="font-semibold text-foreground">AI智能剪辑</h3>
        {aiEditingData && (
      ...
      <div className="flex-1 overflow-hidden">
        {!aiEditingData ? (
          ...
          <div className="flex flex-col items-center justify-center h-full p-6 text-center">
            ...
            <h4 className="text-lg font-medium mb-2">AI剪辑助手</h4>
            ...
            <div className="mb-4 p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>媒体库状态: {mediaItems.length} 个文件</span>
              </div>
              {mediaItems.length === 0 && (
                <p className="text-xs text-amber-600 mt-1">
                  建议先在媒体面板导入一些视频文件，以获得更好的演示效果
                </p>
              )}
            </div>
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-b border-border">
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-medium">{currentEditingPlan?.version_name}</h4>
                <Button
